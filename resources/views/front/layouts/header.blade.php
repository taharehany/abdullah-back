            ...
            <nav class="navbar main-nav navbar-expand-lg">
                <div class="container">
                    <div class="content"><a class="navbar-brand" href="/">
                            <div class="logo"><img class="light img-fluid" src="{{ asset('front/images/header-logo.svg') }}" alt="alt"><img class="dark img-fluid" src="{{ asset('front/images/header-logo-dark.svg') }}" alt="alt"></div>
                        </a>
